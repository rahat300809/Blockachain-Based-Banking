...
Wallet* create_acc(Blockchain &bc)
{
    ...
    string public_id_record = new_wallet->publickey + "300809";
...
{
    string receiver,amount,encryption_key;
...
Wallet* login_wallet(Blockchain &bc)
{
   ...
   cout << "2. Manual Login (Type Secret & Timestamp)" << endl;
   cout << "Choice: "; 
   cin >> login_choice;
   ...
   if(login_choice == 1)
   {
    cout << "Drag and drop your wallet file here or enter full path: " << endl;
        ...
        if(secret!="" && enc_key!="")
        {
            ...
            cout << ">>> [SUCCESS] Login attempt processed!" << endl;
            return temp_wallet;
        }
        return NULL;
...
int main() 
{
   ...
   while(true)
   {
       cout << "\n===== WELCOME TO BLOCKCHAIN NETWORK =====" << endl;
        ...
        if(wallet!=NULL)
        {
           cout << "logged in as: " << wallet->publickey << "300809" << endl;
           bool loggedin=true;
