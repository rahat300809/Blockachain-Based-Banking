...
if(LOADING_MODE)
{
    // 🔥 No mining during load
    newnode->nonce = 0;
    newnode->hash = calculate_hash(newnode->index, datastr, newnode->previoushash, newnode->timestamp, 0);
}
else
{
    long long target_limit = 100000000; 
...
// ১. তুমি লিখলে "Hello" + ১ = (যোগফল ৫) -> হয়নি।
// ২. তুমি লিখলে "Hello" + ২ = (যোগফল ৯) -> হয়নি।
// ৩. তুমি লিখলে "Hello" + ৩ = (যোগফল ৭) -> Bingo! মাইন হয়ে গেছে।
...
// C:\msys64\mingw64\bin\g++.exe "C:\Users\Surface\OneDrive\Desktop\Blockchain\logissue.cpp" -o "C:\Users\Surface\OneDrive\Desktop\Blockchain\logissue.exe" -I"C:/msys64/mingw64/include" -L"C:/msys64/mingw64/lib" -lssl -lcrypto

// C:\Users\Surface\OneDrive\Desktop\Blockchain\logissue.exe


// $env:PATH = "C:\msys64\mingw64\bin;" + $env:PATH
// C:\msys64\mingw64\bin\g++.exe D:\Blockchain\logissue.cpp -o D:\Blockchain\blockchain_app.exe -I"C:/msys64/mingw64/include" -L"C:/msys64/mingw64/lib" -lssl -lcrypto



// $env:PATH = "C:\msys64\mingw64\bin;" + $env:PATH
// D:\Blockchain\blockchain_app.exe
