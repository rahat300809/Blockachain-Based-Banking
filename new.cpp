...
void save_blockchain(vector<unsigned char>data)
{
    ...
    ofstream file("D:/Blockchain/blockchain.dat", ios::app | ios::binary);blockchain.dat", ios::app | ios::binary);
...
void load_blockchain(Blockchain &bc)
{
    ...
    ifstream file("D:/Blockchain/blockchain.dat", ios::binary);blockchain.dat", ios::binary);
